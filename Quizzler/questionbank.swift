...
class Questionbank
{
    ...
    init(){
        ...
        list.append(Question(text: "Chocolat'e affects a dog\'s heart and nervous system; a few ounces are enough to kill a small dog.", correctAnswer: true))
    }
